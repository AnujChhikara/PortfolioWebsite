function ProjectCard(props) {
  return (
    <div className="projectBg sm:w-[300px] sm:h-80 rounded-xl flex flex-col justify-around py-4 items-center space-y-4 shadow-white shadow-md">
      <div><img src="" alt="" className="w-[260px] h-28 rounded shadow-gray-100 shadow-sm" /></div>
      <div className="flex space-x-4 text-sm mt-4">
        <div className="bg-gray-500 px-3 shadow-white shadow-md">React</div>
        <div className="bg-gray-500 px-3 shadow-white shadow-md">Tailwind</div>
        <div className="bg-gray-500 px-3 shadow-white shadow-md">HTML</div>
      </div>
      <div><h3 className="underline mt-2 text-lg ">{props.title}</h3></div>
