function ProjectCard(props) {
  return (
    <div className="md:w-72 projectBg sm:w-[300px] md:h- sm:h-40 border-[1px] border-gray-400 rounded-md shadow-gray-500 shadow-md px-3 pt-2 hover:scale-105 duration-700">
      <div>
